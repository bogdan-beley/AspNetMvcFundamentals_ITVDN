...
namespace L06_HomeWorkB2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,ProductId,UserId,QuantityOfProducts,PurchaseDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,ProductId,UserId,QuantityOfProducts,PurchaseDate")] Order order)
        {
            if (ModelState.IsValid)
            {
